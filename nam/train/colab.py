...
def run(
    ...
    :param include_files: A regex or list of regex patterns for files to include in the training.
                           Defaults to None, which includes all files.
    :param exclude_files: A regex or list of regex patterns for files to exclude from the training. 
...
def _run_single_file(
    ...
    model.net.export(outdir=model_export_outdir, modelname=modelname)
    if save_plot:
